...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["default~photography-photography-module~pottery-pottery-module"], {
  ...
  /***/
  function node_modulesHallysonhNgxImageviewer__ivy_ngcc__Fesm2015HallysonhNgxImageviewerJs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    var ImageViewerConfig = function ImageViewerConfig() {
      _classCallCheck(this, ImageViewerConfig);
    };
    /**
     * @param {?=} icon
     * @param {?=} tooltip
    ...
    function createButtonConfig(icon, tooltip) {
      var sortId = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : 0;
    ...
    var Button = /*#__PURE__*/function () {
      ...
      _createClass(Button, [{
        ...
        key: "draw",
        value: function draw(ctx, x, y, radius) {
          this.drawPosition = {
            x: x,
            y: y
          };
        ...
        key: "drawIconFont",
        value: function drawIconFont(ctx, centreX, centreY, size) {
          // font settings
    ...
    var ResourceLoader = /*#__PURE__*/function () {
      ...
      _createClass(ResourceLoader, [{
        key: "resetViewport",
        value: function resetViewport(canvasDim) {
        ...
        key: "draw",
        value: function draw(ctx, config, canvasDim, onFinish) {
          // clear canvas
    ...
    var ImageResourceLoader = /*#__PURE__*/function (_ResourceLoader) {
      _inherits(ImageResourceLoader, _ResourceLoader);

      var _super = _createSuper(ImageResourceLoader);

      function ImageResourceLoader() {
        _classCallCheck(this, ImageResourceLoader);

        return _super.apply(this, arguments);
      }

      _createClass(ImageResourceLoader, [{
        key: "setUp",
    ...
    var ImageCacheService = /*#__PURE__*/function () {
      function ImageCacheService() {
        _classCallCheck(this, ImageCacheService);
      ...
      _createClass(ImageCacheService, [{
        key: "getCache",
         ...
         * @return {?}
         */
        value: function getCache(url, page) {
          return this.cache.find(function (i) {
            return i.url === url && i.page === page;
          });
        }
        /**
         * @param {?} url
        ...
        key: "getImage",
        value: function getImage(url, page) {
          var
          /** @type {?} */
        ...
        key: "saveImage",
        value: function saveImage(url, page, image) {
          var
          /** @type {?} */
        ...
        key: "disposeCache",
        value: function disposeCache() {
          this.cache.forEach(function (i) {
            return URL.revokeObjectURL(i.image.src);
          });
          this._cache = [];
        }
      }, {
    ...
    ImageCacheService.ɵfac = function ImageCacheService_Factory(t) {
      return new (t || ImageCacheService)();
    };

    ImageCacheService.ɵprov = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineInjectable"]({
      token: ImageCacheService,
      factory: ImageCacheService.ɵfac,
      providedIn: 'root'
    });
    /** @nocollapse */

    ImageCacheService.ctorParameters = function () {
      return [];
    };
    /** @nocollapse */
    ...
    (function () {
      _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](ImageCacheService, [{
    ...
    var PdfResourceLoader = /*#__PURE__*/function (_ResourceLoader2) {
      _inherits(PdfResourceLoader, _ResourceLoader2);

      var _super2 = _createSuper(PdfResourceLoader);
      ...
      function PdfResourceLoader(_imageCache) {
        ...
        _classCallCheck(this, PdfResourceLoader);

        _this2 = _super2.call(this);
        _this2._imageCache = _imageCache;
      ...
      _createClass(PdfResourceLoader, [{
        key: "setUp",
        value: function setUp() {
          var
          /** @type {?} */
        ...
        key: "loadImage",
        value: function loadImage(src, page, onFinish) {
          var
          /** @type {?} */
          vm = this;
    ...
    var ImageViewerComponent = /*#__PURE__*/function () {
      ...
      function ImageViewerComponent(_sanitizer, _renderer, _imageCache, config) {
        ...
        this._buttons = [this._zoomOutButton, this._zoomInButton, this._rotateLeftButton, this._rotateRightButton, this._resetButton].filter(function (item) {
          return item.display;
        }).sort(function (a, b) {
      ...
      _createClass(ImageViewerComponent, [{
        ...
        value: function ngAfterViewInit() {
          ...
          this._nextPageButton.onClick = function (evt) {
            _this3.nextPage();

            return false;
          };

          this._beforePageButton.onClick = function (evt) {
            _this3.previousPage();

            return false;
          };

          this._zoomOutButton.onClick = function (evt) {
            _this3.zoomOut();

            return false;
          };

          this._zoomInButton.onClick = function (evt) {
            _this3.zoomIn();

            return false;
          };

          this._rotateLeftButton.onClick = function (evt) {
            _this3.rotateLeft();

            return false;
          };

          this._rotateRightButton.onClick = function (evt) {
            _this3.rotateRight();

            return false;
          };

          this._resetButton.onClick = function (evt) {
            _this3.resetImage();
        ...
        value: function setUpResource() {
          ...
          if (this._resource) {
            ...
            this._resourceChangeSub = this._resource.onResourceChange().subscribe(function () {
              ...
              if (_this4.src instanceof File) {
                URL.revokeObjectURL(_this4._resource.src);
              }
            });
        ...
        key: "processTouchEvent",
        value: function processTouchEvent(evt) {
          // process pan
        ...
        value: function addEventListeners() {
          ...
          // zooming
          this._listenDestroyList.push(this._renderer.listen(this._canvas, 'DOMMouseScroll', function (evt) {
            return _this5.onMouseWheel(evt);
          }));

          this._listenDestroyList.push(this._renderer.listen(this._canvas, 'mousewheel', function (evt) {
            return _this5.onMouseWheel(evt);
          })); // show tooltip when mouseover it


          this._listenDestroyList.push(this._renderer.listen(this._canvas, 'mousemove', function (evt) {
            return _this5.checkTooltipActivation(_this5.screenToCanvasCentre({
              x: evt.clientX,
              y: evt.clientY
            }));
          }));
        ...
        key: "checkTooltipActivation",
        value: function checkTooltipActivation(pos) {
          this.getUIElements().forEach(function (x) {
        ...
        value: function render() {
          ...
          if (this._dirty && this._resource) {
            ...
            this._resource.draw(ctx, this.config, this._canvas, function () {
              ctx.restore();

              if (vm._resource.loaded) {
                // draw buttons
                _this6.drawButtons(ctx); // draw paginator


                if (_this6._resource.showItemsQuantity) {
                  _this6.drawPaginator(ctx);
                }
              }
            });
          }
        ...
        key: "drawButtons",
        value: function drawButtons(ctx) {
          var
          /** @type {?} */
        ...
        key: "drawPaginator",
        value: function drawPaginator(ctx) {
          var
          /** @type {?} */
          padding = this.config.tooltips.padding;
          var
        ...
        value: function drawRoundRectangle(ctx, x, y, width, height, radius, fill, stroke) {
        ...
        key: "extendsDefaultConfig",
        value: function extendsDefaultConfig(cfg) {
          var
          /** @type {?} */
        ...
        key: "screenToCanvasCentre",
        value: function screenToCanvasCentre(pos) {
          var
          /** @type {?} */
        ...
        key: "getUIElement",
        value: function getUIElement(pos) {
          var
          /** @type {?} */
          activeUIElement = this.getUIElements().filter(function (uiElement) {
    ...
    ImageViewerComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      ...
      decls: 2,
      vars: 2,
      consts: [[3, "width", "height", "tap", "pinchin", "pinchout", "panmove", "panend", "rotatemove", "rotateend"], ["imageContainer", ""]],
      template: function ImageViewerComponent_Template(rf, ctx) {
        if (rf & 1) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("tap", function ImageViewerComponent_Template_canvas_tap_0_listener($event) {
            return ctx.onTap($event);
          })("pinchin", function ImageViewerComponent_Template_canvas_pinchin_0_listener($event) {
            return ctx.processTouchEvent($event);
          })("pinchout", function ImageViewerComponent_Template_canvas_pinchout_0_listener($event) {
            return ctx.processTouchEvent($event);
          })("panmove", function ImageViewerComponent_Template_canvas_panmove_0_listener($event) {
            return ctx.processTouchEvent($event);
          })("panend", function ImageViewerComponent_Template_canvas_panend_0_listener() {
            return ctx.onTouchEnd();
          })("rotatemove", function ImageViewerComponent_Template_canvas_rotatemove_0_listener($event) {
            return ctx.processTouchEvent($event);
          })("rotateend", function ImageViewerComponent_Template_canvas_rotateend_0_listener() {
            return ctx.onTouchEnd();
          });
    ...
    var ImageViewerModule = function ImageViewerModule() {
      _classCallCheck(this, ImageViewerModule);
    };

    ImageViewerModule.ɵmod = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineNgModule"]({
      type: ImageViewerModule
    });
    ImageViewerModule.ɵinj = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineInjector"]({
      factory: function ImageViewerModule_Factory(t) {
    ...
    (function () {
      (typeof ngJitMode === "undefined" || ngJitMode) && _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵsetNgModuleScope"](ImageViewerModule, {
    ...
    (function () {
      _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](ImageViewerModule, [{
...
//# sourceMappingURL=default~photography-photography-module~pottery-pottery-module-es5.js.map